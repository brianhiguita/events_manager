  <footer class="container-fluid">
    <div class="row">
      <div class="footer-hr col-md-10 offset-md-1">
      </div>
    </div>
      ...
      <div class="col-md-10 offset-md-1">
        ...
        <!-- <div class="col-md-4">
          <div class="">
              ...
              <input type="email" class="form-control subscribe" placeholder="Enter your email"><button class="btn" type="submit">Subscribe</button>
          </div>
        </div> -->

        <div class="col-md-12">
          <div class="text-center center-block" style="color:white">
            <p>Website Designed and Developed by Brian Higuita</p>
          </div>
        </div>
